...
参考链接：https://mp.weixin.qq.com/mp/homepage?__biz=Mzg2NTAzMTExNg==&hid=3&sn=456dc4d66f0726730757e319ffdaa23e&scene=18#wechat_redirect
...
```xml
<!--Handler-->
<bean id="/hello" class="com..simpleteen.controller.HelloController"/>
```
...
4. ```
   ...
   <beans xmlns="http://www.springframework.org/schema/beans"
       ...
       <context:component-scan base-package="com.simpleteen.controller"/>
       <!-- 让Spring MVC不处理静态资源 -->
...
4. 编写完毕后，去Spring配置文件中注册请求的bean；name对应请求路径，class对应处理请求的类
   ...
   ```xml
   <bean name="/t1" class="com.simpleteen.controller.ControllerTest1"/>
   ```
...
```xml
    ...
    <mvc:interceptors>
        <mvc:interceptor>
            ...
            <mvc:mapping path="/**"/>
            <!--bean配置的就是拦截器-->
            <bean class="com.simpleteen.config.MyInterceptor"/>
        </mvc:interceptor>
    </mvc:interceptors>
```
